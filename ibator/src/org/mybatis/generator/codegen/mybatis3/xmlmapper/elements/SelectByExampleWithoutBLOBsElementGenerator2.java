...
public class SelectByExampleWithoutBLOBsElementGenerator2 extends AbstractXmlElementGenerator
{
  public void addElements(XmlElement parentElement)
  {
    ...
    answer.addAttribute(new Attribute("id", 
      this.introspectedTable.getSelectByExampleStatementId() + "AndPage"));
