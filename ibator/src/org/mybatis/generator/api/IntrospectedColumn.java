...
public class IntrospectedColumn
{
  ...
  public boolean isStringColumn() {
    return FullyQualifiedJavaType.getStringInstance().equals(
    		this.fullyQualifiedJavaType);
  }

  public boolean isJdbcCharacterColumn()
  {
    return (this.jdbcType == 1) || (this.jdbcType == 2005) || 
      (this.jdbcType == -1) || (this.jdbcType == 12);
  }
  ...
  public boolean isJDBCDateColumn() {
    if (FullyQualifiedJavaType.getDateInstance().equals(
    		this.fullyQualifiedJavaType))
